            ...
            <div className="space-y-12">
                ...
                <section className="space-y-6">
                    ...
                    <div className="border-t border-slate-100 pt-8">
                        ...
                        <p className="text-slate-500 text-sm italic">
                            NurseFlex offers all of its users rights to access and delete their data, as detailed in the <Link href="#" className="text-blue-600 underline">"Your personal data rights"</Link> section of our Privacy Policy. To access or delete your data held by NurseFlex, just fill out this <Link href="#" className="text-blue-600 underline">personal data request form</Link>.
                        </p>
                    </div>
                    ...
                    <div className="border-t border-slate-100 pt-8">
                        ...
                        <p className="text-slate-500 text-sm italic">
                            You can also set your NurseFlex Resume to "not searchable" by visiting your <Link href="#" className="text-blue-600 underline">resume privacy settings</Link>. For more information on what it means to have a "searchable" or "not searchable" NurseFlex Resume, please visit the <Link href="#" className="text-blue-600 underline">"Data collection and use"</Link> section of our Privacy Policy.
                        </p>
                    </div>
                </section>
            </div>
