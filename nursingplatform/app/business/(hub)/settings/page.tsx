        ...
        <div className="max-w-5xl mx-auto space-y-12 pb-20 animate-in fade-in duration-1000">
            <header className="flex flex-col md:flex-row justify-between items-center gap-8 border-b border-slate-100 pb-12">
                ...
                <Button
                    onClick={handleSave}
                    disabled={saving}
                    className="h-16 px-10 rounded-2xl bg-blue-600 hover:bg-blue-700 font-bold text-sm shadow-2xl transition-all"
                >
            ...
            {success && (
                <div className="p-6 rounded-[2rem] bg-blue-50 border border-blue-100/50 text-blue-700 flex items-center gap-4 shadow-2xl shadow-blue-50 animate-in slide-in-from-top-4 sticky top-4 z-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <aside className="lg:col-span-3 space-y-4">
                    {[
                        ...
                        <button
                            key={item.label}
                            className={`w-full flex items-center gap-4 p-5 rounded-2xl transition-all font-bold text-xs ${item.active ? 'bg-slate-900 text-white shadow-xl shadow-slate-200' : 'text-slate-400 hover:bg-slate-50'
                                }`}
                        >
                            <item.icon size={16} />
                            {item.label}
                    ...
                    <Card id="team" className="border-none shadow-sm bg-white rounded-[3rem] overflow-hidden scroll-mt-10">
                        ...
                        <CardContent className="p-10 space-y-6">
                            ...
                            <Button
                                ...
                                className="w-full h-14 rounded-2xl border-slate-200 border-dashed hover:border-blue-600 hover:bg-blue-50/30 font-bold text-slate-400 hover:text-blue-600 transition-all"
                            >
                        ...
                        <CardContent className="p-10 space-y-6">
                            {[
                                ...
                                <div key={pref.id} className="group flex items-start gap-4 p-6 rounded-3xl border border-transparent hover:border-slate-100 hover:bg-slate-50/50 transition-all duration-500">
                                    <div className="pt-1">
                                        <Checkbox id={pref.id} defaultChecked className="h-6 w-6 rounded-lg border-slate-200 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 transition-all" />
                                    </div>
                                    <div className="space-y-1">
                                        <Label htmlFor={pref.id} className="text-sm font-bold text-slate-900 tracking-tight cursor-pointer group-hover:text-blue-600 transition-colors">{pref.label}</Label>
