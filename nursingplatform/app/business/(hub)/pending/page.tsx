  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-center">
      <div className="max-w-md bg-white p-12 rounded-[3rem] shadow-2xl border border-indigo-100">
        <div className="w-24 h-24 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center text-4xl mx-auto mb-8 shadow-inner shadow-blue-100/50">
          ⏳
        </div>
        <h2 className="text-3xl font-bold text-slate-900 tracking-tight mb-4">Application Pending</h2>
        <p className="text-slate-500 font-medium text-sm mb-8 leading-relaxed">
          Your request is currently being reviewed by our team. Once approved, you'll be able to <span className="text-blue-600 font-bold">post jobs</span> and manage your hiring from the dashboard.
        </p>
        <Link href="/">
          <button className="text-xs font-bold text-slate-400 hover:text-blue-600 transition-all">
            ← Back to Home
          </button>
        </Link>
