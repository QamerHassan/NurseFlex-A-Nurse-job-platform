    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
          <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm w-full sm:w-80 transition-all focus-within:ring-2 focus-within:ring-blue-500/10 focus-within:border-blue-500/30">
              ...
              <tbody className="divide-y divide-slate-50">
                {filtered.length === 0 ? (
                  ...
                  <tr key={user.id} className="group hover:bg-slate-50/50 transition-all">
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-0.5">
                          <p className="font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{user.name || "Unnamed User"}</p>
                    ...
                    <td className="px-8 py-6">
                      <Badge variant="outline" className="h-8 px-3 rounded-lg border-blue-100 text-blue-600 text-xs font-bold bg-blue-50/30 gap-2">
